...
const Footer = () => {
    return (
        <div className=' bg-[#acacb0] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-4 h-8 md:h-9' />
                    <p className='text-sm'>
                        Discover the world's most extraordinary places to stay, from boutiques hotels to luxury villas and private islands.
                    </p>
                ...
                <div>
                    <p className='text-lg text-gray-950 font-playfair'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80 font-playfair'>
